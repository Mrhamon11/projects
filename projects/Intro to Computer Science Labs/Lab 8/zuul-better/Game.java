...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        Item book = new Item("Book", "Contains magical spells", 2.0);
        Item flightBooks = new Item("Flight Boots", "Wearer gains the ability to fly", 3.4);
        Item potion = new Item("Potion", "Heals player's health", 1.2);
    ...
    /**
     * This method will print out the long description of the
