...
class Book
{
    ...
    {
        if (refNumber == "") {
            System.out.print ("Title: " + title + ", " + "Author: " + author + ", " + "Pages: " + pages + ", " + "Reference Number: " + "ZZZ");
        }
        else {
            System.out.print ("Title: " + title + ", " + "Author: " + author + ", " + "Pages: " + pages + ", " + "Reference Number: " + refNumber);
        }
    }
    // Reference number 
