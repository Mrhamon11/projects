...
/**
 * The Professor class is a subclass of Actor. This subclass is 
 * another character in the game that travels throughout the game field,
 * but instead of moving by the user's command, it will move in a random 
 * direction and face a random direction based on a dice roll. 
 * 
 * @author Avraham Amon
 * @version 12/8/14
 */
